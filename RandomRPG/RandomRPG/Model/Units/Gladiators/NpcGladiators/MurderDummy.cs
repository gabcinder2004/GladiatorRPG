...
namespace RandomRPG.Model.Units.Gladiators.NpcGladiators
{
    public class MurderDummy : NpcGladiator
    {
        public MurderDummy(string name)
            : base(name, GladiatorTypes.MurderDummy)
        {
